package com.neu.application.service.authentication

import com.google.common.net.UrlEscapers
import com.neu.application.core.{ AuthenticationManager, Md5 }
...
import com.neu.application.model.RebrandJsonProtocol.{ *, given }
