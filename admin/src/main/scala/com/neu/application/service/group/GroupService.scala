package com.neu.application.service.group
...
import com.neu.application.model.WafJsonProtocol.{
  exportedWafSensorListToJson,
  wafGroupConfigToJson,
  wafSensorConfigToJson
}
import com.neu.application.model.DlpJsonProtocol.{
  dlpGroupConfigToJson,
  dlpSensorConfigToJson,
  exportedDlpSensorListToJson
}
import com.neu.application.model.FileProfileJsonProtocol.fileProfileToJson
import com.neu.application.model.ProcessProfileJsonProtocol.profileConfigToJson
import com.neu.application.model.SystemConfigJsonProtocol.{
  serviceConfigToJson,
  systemConfigWrapToJson,
  systemRequestToJson
}
import com.neu.application.model.CustomCheckConfigJsonProtocol.customConfigToJson
