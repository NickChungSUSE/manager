package com.neu.application.service.workload
...
import com.neu.application.model.NamespaceJsonProtocol.{ configWrapToJson, domainConfigWrapToJson }
import com.neu.application.model.ContainerConfigJsonProtocol.{
  quarantineConfigWarpToJson,
  snifferParamWarpToJson
}
